...
send.addEventListener("click", () => {
    axios.post("https://oguz-fe9a7-default-rtdb.firebaseio.com/testimonials.json", { id: Date.now(), description: description.value, title: title.value, image: newFile, text: text.value })
        .then(res => {
            text.value = ""
            title.value = ""
            description.value = ""
